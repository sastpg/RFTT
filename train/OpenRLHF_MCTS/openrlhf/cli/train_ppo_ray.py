...
if __name__ == "__main__":
    ...
    parser.add_argument("--logging_path", type=str, default="./logs/train_logs.jsonl")
    ...
    # MCTS
    parser.add_argument("--save_tree", type=str, default=None, help="Path to save mcts trace")
    parser.add_argument("--search_depth", type=int, default=16, help="Max tree depth for MCTS")
    parser.add_argument(
        "--sampling_method",
        type=str,
        choices=["mcts", "normal", "beam"],
        default="normal",
        help="Choose sampling method: mcts, normal, beam",
    )
